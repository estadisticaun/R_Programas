...
drive_download("Estadisticas UN/Programas/P2009 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P2010 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P2011 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P2012 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P2013 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P2014 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P2015 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P2016 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P2017 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P20181 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P20182 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P20191 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P20192 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P20192 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P20201 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P20202 Programas.xlsx", overwrite = TRUE)
drive_download("Estadisticas UN/Programas/P20211 Programas.xlsx", overwrite = TRUE)
...
G2009 <- importar("P2009 Programas.xlsx", "P2009G") 
G2010 <- importar("P2010 Programas.xlsx", "P2010G") 
G2011 <- importar("P2011 Programas.xlsx", "P2011G") 
G2012 <- importar("P2012 Programas.xlsx", "P2012G") 
G2013 <- importar("P2013 Programas.xlsx", "P2013G") 
G2014 <- importar("P2014 Programas.xlsx", "P2014G") 
G2015 <- importar("P2015 Programas.xlsx", "P2015G") 
G2016 <- importar("P2016 Programas.xlsx", "P2016G") 
G2017 <- importar("P2017 Programas.xlsx", "P2017G") 
G20181 <- importar("P20181 Programas.xlsx", "P20181G")
G20182 <- importar("P20182 Programas.xlsx", "P20182G") 
G20191 <- importar("P20191 Programas.xlsx", "P20191G") 
G20192 <- importar("P20192 Programas.xlsx", "P20192G") 
G20201 <- importar("P20201 Programas.xlsx", "P20201G") 
G20202 <- importar("P20202 Programas.xlsx", "P20202G") 
G20211 <- importar("P20211 Programas.xlsx", "P20211G") 


Microdatos <- bind_rows(G2009, G2010, G2011, G2012, G2013, G2014, G2015, G2016, G2017, G20181, G20182, G20191, G20192,
                        G20201, G20202, G20211)
...
unlink(c('P2009 Programas.xlsx', 'P2010 Programas.xlsx', 'P2011 Programas.xlsx',
         'P2012 Programas.xlsx', 'P2013 Programas.xlsx', 'P2014 Programas.xlsx', 
         'P2015 Programas.xlsX', 'P2016 Programas.xlsx', 'P2017 Programas.xlsx',
         'P20181 Programas.xlsx', 'P20182 Programas.xlsx', 'P20191 Programas.xlsx',
         'P20192 Programas.xlsx', 'P20201 Programas.xlsx', 'P20202 Programas.xlsx',
         'P20211 Programas.xlsx'))
...
# Consolidado Estadística Programas Universidad
...
rm(Agregado, DT1, DT2, DT3, DT4, DT5, DT6, DT7, DT8, DT9, DT10, 
   ...
   G2017, G20181, G20182, G20191, G20192, G20201, G20202, 
   G20211, Gra1100, Gra1101,
